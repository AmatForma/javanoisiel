...
<body>
 ...
 <%@include file="menu.jsp" %>
	...
	<div class="corps">
			...
			<h1>Liste des Formation et Module </h1>
	...
	<table class="table">
		...
		<c:forEach items="${modform}" var="modform">
			<tr>
				<td>${modform.formattion.getIntitule()}</td>
				<td>${modform.module.getIntitule()}</td>
                                <td>${modform.module.getNbJour()}</td>
    ...
    <td><p data-placement="top" data-toggle="tooltip" title="Delete"><button class="btn btn-danger btn-xs" data-title="Delete" data-toggle="modal" data-target="#delete" ><span class="glyphicon glyphicon-trash"></span></button></p></td>
                ...
                <!-- /.modal-dialog --> 
                             ...
                             <div>   <input class="btn btn-primary" type="submit" value="Ajouter Formation"  >
                                 <input class="btn btn-primary" type="submit" value="Refraichir"></div>
