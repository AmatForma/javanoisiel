            ...
            <table class="table">
                ...
                <c:forEach items="${formations}" var="formations">
                    ...
                    <form action="supforma" method="post"> 
                        ...
                        <td><p> <button type="submit" name="Modifier" value="supprimer" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-trash"></span></button> </p></td>
                        <td><p> <button type="submit" name="Modifier" value="editer" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-pencil"></span></button> </p></td>
                            
                           <!-- <p data-placement="top" data-toggle="tooltip" title="Edit"><button class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" ><span class="glyphicon glyphicon-pencil"></span></button></p></td> -->
